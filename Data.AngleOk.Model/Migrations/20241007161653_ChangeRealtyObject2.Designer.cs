...
namespace Data.AngleOk.Model.Migrations
{
    ...
    [Migration("20241007161653_ChangeRealtyObject2")]
    partial class ChangeRealtyObject2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.AngleOk.Model.Models.City", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("RegionId")
                        .HasColumnType("uuid")
                        .HasComment("Идентификатор субъекта");

                    b.HasKey("Id");

                    b.HasIndex("RegionId");

                    b.ToTable("City", "public", t =>
                        {
                            t.HasComment("Города");
                        });
                });
            ...
            modelBuilder.Entity("Data.AngleOk.Model.Models.Country", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("Alpha2")
                        ...
                        .HasComment("Alpha-2 код по ISO 3166-1");

                    b.Property<string>("Alpha3")
                        .IsRequired()
                        .HasMaxLength(3)
                        .HasColumnType("character varying(3)")
                        .HasComment("Alpha-3 код по ISO 3166-1");

                    b.Property<string>("EnglishName")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasComment("Наименование на английском языке");
                    ...
                    b.Property<int>("Iso")
                        .HasColumnType("integer")
                        .HasComment("Iso код по ISO 3166-1");
            ...
            modelBuilder.Entity("Data.AngleOk.Model.Models.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Region", "public", t =>
                        {
                            t.HasComment("Субъекты");
                        });
                });
            ...
            modelBuilder.Entity("Data.AngleOk.Model.Models.Street", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Data.AngleOk.Model.Models.City", b =>
                {
                    b.HasOne("Data.AngleOk.Model.Models.Region", "Region")
                        .WithMany()
            ...
            modelBuilder.Entity("Data.AngleOk.Model.Models.Region", b =>
                {
                    b.HasOne("Data.AngleOk.Model.Models.Country", "Country")
                        .WithMany()
